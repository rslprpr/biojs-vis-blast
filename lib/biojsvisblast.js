...
var width = 400,height = 40, seq_height = 10, padding = 5;
...
var drawAlignment = function (alignment, element) {
	...
	svg.append("rect")
		...
		.attr("y",padding/2)
		.attr("height", (2*seq_height) + padding*2)
	...
	svg.append("rect")
		.attr("x","0")
		.attr("y","0")
		.attr("width",scale(alignment.match_start))
		.attr("height",height)
		.attr("fill","white")
	...
	// right mask
	svg.append("rect")
		.attr("x",scale(alignment.match_start) + scale(alignment.match_length))
		.attr("y","0")
		.attr("width",width - scale(alignment.match_length) - scale(alignment.match_start))
		.attr("height",height)
		.attr("fill","white")
		.attr("fill-opacity",0.7);
};
